...
public class SendFileEmail {
   ...
   // @AfterSuite
    ...
    public  static void sendPDFReportByGMail(String from, String pass, String to, String cc, String BCC, String subject, String body) {
...
try {
		...
		String filename = constant.ReportPath();
